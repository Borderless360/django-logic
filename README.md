...
Use the ready-made schedule. It routes all four tasks to `DJANGO_LOGIC['STARTER_QUEUE']` with the recommended intervals — retry 60s, detect-stuck 300s, watchdog 120s, cleanup daily — and you can override each one by keyword:
